...
import { deleteJurnal, getJurnalDataById, getJurnalDataCleaningById } from '@/api/database';
...
export default function JournalTable({ onDeleteSuccess, setSelectedJournal, entries }: JournalTableProps) {
  ...
  const handleRowClick = async (id: number) => {
    setIsLoading(true);
    const journal = await getJurnalDataCleaningById(id);
    console.log(`Selected journal with id: ${id}`, journal);
