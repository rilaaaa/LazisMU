...
import { PlusIcon, XCircleIcon, ArrowLeftIcon, ArrowDownTrayIcon } from '@heroicons/react/24/outline';
...
export default function JournalPage() {
  const {
    ...
    journalEntries, clearFilters,
    fetchJournalEntries, filteredEntries
  } = useJournalEntries();
